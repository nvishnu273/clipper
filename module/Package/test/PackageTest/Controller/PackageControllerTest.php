<?php
namespace PackageTest\Controller;
 
use PackageTest\Bootstrap;
use Package\Controller\PackageController;
...
class PackageControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->routeMatch = new RouteMatch(array('controller' => 'package'));
